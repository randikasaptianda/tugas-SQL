...
const EditProduct = () => {
  ...
  return (
    <div>
      <h1 className="font-bold text-black-600 mt-5 ml-20 text-2xl ">Form Edit Product</h1>

      <form onSubmit={updateProduct} className="w-full bg-stone-600 border border-blue-900 rounded-2xl mt-2 ml-20 p-4 max-w-sm  ">
